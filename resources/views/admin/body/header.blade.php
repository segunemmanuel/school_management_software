	  ...
	  <div>
		  <ul class="nav">
			<li class="btn-group nav-item">
				<a href="#" class="rounded waves-effect waves-light nav-link svg-bt-icon" data-toggle="push-menu" role="button">
			...
			<li class="btn-group nav-item d-none d-xl-inline-block">
				<a href="calendar.html" class="rounded waves-effect waves-light nav-link svg-bt-icon" title="">
